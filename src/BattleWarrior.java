            ...
            do {
                switch (userPickedSetting){
                    ...
                    case ("Forest of Futility"):
                        ...
                        System.out.println("You have chosen to test your luck in the Forest of Futility as the Battle Warrior\nThis map does not play to the strengths of the Battle Warrior with open spaces and freedom to move and limited visibility it is not the perfect place for you to showcase your skills.\n Good luck!");
                        break;
                    case ("Highrise"):
